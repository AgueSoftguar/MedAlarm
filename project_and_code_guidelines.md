...
```java
Picasso.with(context).load("http://aguesoftguar.es/images/sexyjoe.jpg").into(imageView);
```

```java
Picasso.with(context)
        .load("http://aguesoftguar.es/images/sexyjoe.jpg")
        .into(imageView);
```
...
```java
loadPicture(context, "http://aguesoftguar.es/images/sexyjoe.jpg", mImageViewProfilePicture, clickListener, "Title of the picture");
```

```java
loadPicture(context,
        "http://aguesoftguar.es/images/sexyjoe.jpg",
        mImageViewProfilePicture,
        clickListener,
        "Title of the picture");
```

### 2.2.13 RxJava chains styling
